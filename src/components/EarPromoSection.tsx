    ...
    <section>
      <div className="px-6 md:px-[120px] py-12 pt-24">
        <div className="grid md:grid-cols-[1fr,auto,1fr] items-center gap-4 md:gap-6">
          <div className="text-teal-700 text-[84px] md:text-[132px] font-bold tracking-wide leading-none text-center md:text-left">HEAR</div>
      ...
      <div className="bg-white">
        <div className="px-4 sm:px-6 md:px-[120px] py-10 space-y-8">
